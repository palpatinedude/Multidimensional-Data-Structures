...
by different algorithms (QuickHull3D or Divide & Conquer 3D)
from the results folder, visualizes them in 3D, and optionally
plots measured time and memory usage from CSV results.

- The script handles both vertex/face-based (QuickHull3D) and
  point/hull-based (Divide & Conquer 3D) formats.
"""
...
#folder = "../results/divideConquer3D/"
...
def extract_n(filename):
    """
    Extracts input size n from filenames like:
      quickHull3D_points_100_1.txt
    """
